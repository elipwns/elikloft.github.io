...
const PIR = [
  // Main straight → T1 entry (way 5529392, nodes 0–36)
...
const PIR_SPEED_KPH = [
  // Main straight → T1 entry (indices 0–4)
  150, 155, 158, 152, 135,
  // T1 braking and apex complex (indices 5–13)
  115,  90,  82,  76,  70,  65,  63,  62,  63,
  // T1 exit, building speed (indices 14–18)
   65,  70,  74,  78,  82,
  // Back section, long acceleration (indices 19–29)
   86,  90,  94,  97, 100, 105, 115, 125, 133, 138, 142,
  // Western chicane approach (indices 30–36)
  140, 128, 115, 102,  90,  85,  82,
  // Connector (index 37)
   82,
  // Carousel entry (indices 38–46)
   80,  78,  78,  78,  80,  82,  85,  88,  90,
  // Carousel loop (indices 47–57)
   92,  94,  95,  95,  97,  97,  95,  93,  90,  88,  85,
  // Carousel exit → NE (indices 58–67)
   90,  94,  98, 102, 108, 112, 115, 118, 120, 122,
  // Main straight return (indices 68–85)
